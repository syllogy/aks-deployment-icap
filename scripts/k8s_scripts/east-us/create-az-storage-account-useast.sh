...
LOCATION=EASTUS
RESOURCE_GROUP_NAME=gw-icap-tfstate-eastus
STORAGE_ACCOUNT_NAME=eastustfstate$RANDOM
CONTAINER_NAME=gw-icap-tfstate-eastus
SHARE_NAME01=transactions
SHARE_NAME02=policies
VAULT_NAME=gw-tfstate-vault-eastus
